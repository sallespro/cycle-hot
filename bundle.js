...
},{"./src/app":66,"@cycle/core":2,"@cycle/dom":3,"@cycle/isolate":60,"cycle-restart":63}],2:[function(require,module,exports){
"use strict";
...
},{"./fromevent":4,"./transposition":8,"./virtual-hyperscript":10,"matches-selector":12,"rx":65,"vdom-parser":13,"virtual-dom/diff":28,"virtual-dom/patch":35}],7:[function(require,module,exports){
"use strict";
...
},{"./transposition":8,"rx":65,"vdom-to-html":17}],8:[function(require,module,exports){
"use strict";
...
},{"rx":65,"virtual-dom/vnode/vnode":54}],9:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
},{"./restartable":64,"@cycle/core":2,"rx":65}],64:[function(require,module,exports){
'use strict';
...
},{"rx":65}],65:[function(require,module,exports){
...
"use strict";function view(t){return(0,_dom.div)(".counter",[(0,_dom.div)(".count","Count: "+t),(0,_dom.button)(".subtract","Subtract"),(0,_dom.button)(".add","Add")])}function App(t){var e=t.DOM,r=e.select(".add").events("click").map(function(t){return 1}),n=e.select(".subtract").events("click").map(function(t){return-1}),u=r.merge(n).startWith(0).scan(function(t,e){return t+e});return{DOM:u.map(view)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=App;var _dom=require("@cycle/dom"),_rx=require("rx");
